...
C_SRCS += \
../Core/Peripherials/I2C/i2c_it.c 

OBJS += \
./Core/Peripherials/I2C/i2c_it.o 

C_DEPS += \
./Core/Peripherials/I2C/i2c_it.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Peripherials/I2C/%.o Core/Peripherials/I2C/%.su Core/Peripherials/I2C/%.cyclo: ../Core/Peripherials/I2C/%.c Core/Peripherials/I2C/subdir.mk
...
clean-Core-2f-Peripherials-2f-I2C:
	-$(RM) ./Core/Peripherials/I2C/i2c_it.cyclo ./Core/Peripherials/I2C/i2c_it.d ./Core/Peripherials/I2C/i2c_it.o ./Core/Peripherials/I2C/i2c_it.su

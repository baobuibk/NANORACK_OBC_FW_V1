...
C_SRCS += \
../Core/Peripherials/UART/uart.c 

OBJS += \
./Core/Peripherials/UART/uart.o 

C_DEPS += \
./Core/Peripherials/UART/uart.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Peripherials/UART/%.o Core/Peripherials/UART/%.su Core/Peripherials/UART/%.cyclo: ../Core/Peripherials/UART/%.c Core/Peripherials/UART/subdir.mk
...
clean: clean-Core-2f-Peripherials-2f-UART

clean-Core-2f-Peripherials-2f-UART:
	-$(RM) ./Core/Peripherials/UART/uart.cyclo ./Core/Peripherials/UART/uart.d ./Core/Peripherials/UART/uart.o ./Core/Peripherials/UART/uart.su

.PHONY: clean-Core-2f-Peripherials-2f-UART

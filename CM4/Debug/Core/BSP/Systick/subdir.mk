...
C_SRCS += \
../Core/BSP/Systick/systick.c 

OBJS += \
./Core/BSP/Systick/systick.o 

C_DEPS += \
./Core/BSP/Systick/systick.d 


# Each subdirectory must supply rules for building sources it contributes
Core/BSP/Systick/%.o Core/BSP/Systick/%.su Core/BSP/Systick/%.cyclo: ../Core/BSP/Systick/%.c Core/BSP/Systick/subdir.mk
...
clean: clean-Core-2f-BSP-2f-Systick

clean-Core-2f-BSP-2f-Systick:
	-$(RM) ./Core/BSP/Systick/systick.cyclo ./Core/BSP/Systick/systick.d ./Core/BSP/Systick/systick.o ./Core/BSP/Systick/systick.su

.PHONY: clean-Core-2f-BSP-2f-Systick

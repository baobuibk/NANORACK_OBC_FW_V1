...
C_SRCS += \
../Core/BSP/Logger/log.c 

OBJS += \
./Core/BSP/Logger/log.o 

C_DEPS += \
./Core/BSP/Logger/log.d 


# Each subdirectory must supply rules for building sources it contributes
Core/BSP/Logger/%.o Core/BSP/Logger/%.su Core/BSP/Logger/%.cyclo: ../Core/BSP/Logger/%.c Core/BSP/Logger/subdir.mk
...
clean: clean-Core-2f-BSP-2f-Logger

clean-Core-2f-BSP-2f-Logger:
	-$(RM) ./Core/BSP/Logger/log.cyclo ./Core/BSP/Logger/log.d ./Core/BSP/Logger/log.o ./Core/BSP/Logger/log.su

.PHONY: clean-Core-2f-BSP-2f-Logger

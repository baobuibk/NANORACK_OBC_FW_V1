...
C_SRCS += \
../Core/Task/Fake_EXP/fake_exp.c 

OBJS += \
./Core/Task/Fake_EXP/fake_exp.o 

C_DEPS += \
./Core/Task/Fake_EXP/fake_exp.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Task/Fake_EXP/%.o Core/Task/Fake_EXP/%.su Core/Task/Fake_EXP/%.cyclo: ../Core/Task/Fake_EXP/%.c Core/Task/Fake_EXP/subdir.mk
...
clean: clean-Core-2f-Task-2f-Fake_EXP

clean-Core-2f-Task-2f-Fake_EXP:
	-$(RM) ./Core/Task/Fake_EXP/fake_exp.cyclo ./Core/Task/Fake_EXP/fake_exp.d ./Core/Task/Fake_EXP/fake_exp.o ./Core/Task/Fake_EXP/fake_exp.su

.PHONY: clean-Core-2f-Task-2f-Fake_EXP

...
C_DEPS += \
./Core/Task/LED_Blink/blink_led_debug.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Task/LED_Blink/%.o Core/Task/LED_Blink/%.su Core/Task/LED_Blink/%.cyclo: ../Core/Task/LED_Blink/%.c Core/Task/LED_Blink/subdir.mk
...
clean: clean-Core-2f-Task-2f-LED_Blink

clean-Core-2f-Task-2f-LED_Blink:
	-$(RM) ./Core/Task/LED_Blink/blink_led_debug.cyclo ./Core/Task/LED_Blink/blink_led_debug.d ./Core/Task/LED_Blink/blink_led_debug.o ./Core/Task/LED_Blink/blink_led_debug.su

.PHONY: clean-Core-2f-Task-2f-LED_Blink

...
BSP/Logger/%.o BSP/Logger/%.su BSP/Logger/%.cyclo: ../BSP/Logger/%.c BSP/Logger/subdir.mk
...
clean: clean-BSP-2f-Logger

clean-BSP-2f-Logger:
	-$(RM) ./BSP/Logger/log.cyclo ./BSP/Logger/log.d ./BSP/Logger/log.o ./BSP/Logger/log.su

.PHONY: clean-BSP-2f-Logger

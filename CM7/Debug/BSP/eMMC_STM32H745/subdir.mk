...
C_SRCS += \
../BSP/eMMC_STM32H745/emmc_stm32h745zi.c 

OBJS += \
./BSP/eMMC_STM32H745/emmc_stm32h745zi.o 

C_DEPS += \
./BSP/eMMC_STM32H745/emmc_stm32h745zi.d 


# Each subdirectory must supply rules for building sources it contributes
BSP/eMMC_STM32H745/%.o BSP/eMMC_STM32H745/%.su BSP/eMMC_STM32H745/%.cyclo: ../BSP/eMMC_STM32H745/%.c BSP/eMMC_STM32H745/subdir.mk
...
clean: clean-BSP-2f-eMMC_STM32H745

clean-BSP-2f-eMMC_STM32H745:
	-$(RM) ./BSP/eMMC_STM32H745/emmc_stm32h745zi.cyclo ./BSP/eMMC_STM32H745/emmc_stm32h745zi.d ./BSP/eMMC_STM32H745/emmc_stm32h745zi.o ./BSP/eMMC_STM32H745/emmc_stm32h745zi.su

.PHONY: clean-BSP-2f-eMMC_STM32H745
